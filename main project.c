...
rec item;   /// making an object globally....
...
void m_edit()
{
    ...
    getch();
    ///fclose(file);///ask to mam to get a better solution....
    main_menu();
}
void m_display()
{
...
void m_delete()
{
    ...
    if(flag==0)
    {
        ...
        system("del /f record.txt");///ask mam to get a better solution....
        fclose(file1);
...
void m_exit()
{
    char team[]="< Dark Knight >";
    char var[]="\"Bangladesh University Of Business And Technology\"";
    //char dep[]=
    int t;
    system("cls");
    gotoxy(42,4);
...
/// it shows the end of the code...
/// Happy coding :) :) :)
/// Yes finally I finished it...
/// its been 2.53 AM. I watching live fire in kalshi bosti... Very worried about thousand of people...
